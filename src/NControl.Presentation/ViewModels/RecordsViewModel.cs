...
public partial class RecordsViewModel : ObservableObject, IRefreshable
{
    ...
    public RecordsViewModel(ITaskRecordStore store, RollbackService? rollback = null, NavigationService? nav = null)
    {
        _store = store;
        _rollback = rollback;
        _nav = nav;
    ...
    private async Task LoadAsync()
    {
        try
        {
            ...
            foreach (var r in records)
                Records.Add(new RecordCardViewModel(r, _rollback, _nav));
